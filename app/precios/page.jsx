      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-5 max-w-xl mx-auto text-xl text-gray-500">
            Soluciones nutricionales personalizadas para cada necesidad
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Evaluación inicial completa con análisis de hábitos alimenticios
                y metas personales.
              </p>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Programa personalizado con recetas, menús semanales y guía
                nutricional detallada.
              </p>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-sm text-gray-500">Desde</p>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Acompañamiento profesional para ajustar tu plan según resultados
                y evolución.
              </p>
              <div className="flex items-end justify-between">
                <div>
        ...
        <div className="mt-20 bg-green-50 rounded-2xl p-8 md:p-10 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-6">
            Ofrecemos paquetes combinados y programas especializados para
            deportistas, condiciones médicas y objetivos específicos.
          </p>
