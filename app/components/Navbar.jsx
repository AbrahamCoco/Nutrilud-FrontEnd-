        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-green-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link href="/articulo" className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Artículos</Link>
              <Link href="/servicios" className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Servicios</Link>
              <Link href="/nutriologos" className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Nutriólogos</Link>
              <Link href="/precios" className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Precios</Link>
              <Link href="/contacto" className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Contacto</Link>
              {rol && (
                <Link href={`/perfil/${id}/${rol}`} className="block px-3 py-2 text-base font-medium text-white hover:bg-green-700 rounded-md">Mi Perfil</Link>
              )}
            </div>
          </div>
        )}
