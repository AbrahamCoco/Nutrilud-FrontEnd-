            ...
            {experts.map((expert, index) => (
              <div key={index} className="text-center">
                <div className="bg-white p-2 rounded-full inline-block mb-4">
                  <Image src={expert.img} alt={expert.name} className="rounded-full w-32 h-32 object-cover border-4 border-green-300" width={128} height={128} />
                </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-green-50 rounded-xl p-6 shadow-md hover:shadow-lg transition duration-300">
                <div className="flex items-start mb-4">
                  <Image src="/client.png" alt={testimonial.name} className="rounded-full w-12 h-12 mr-4" width={48} height={48} />
                  <div>
