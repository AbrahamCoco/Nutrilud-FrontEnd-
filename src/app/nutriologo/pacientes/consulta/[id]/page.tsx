...
export default function ConsultaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  }, [id, fetchPaciente, fetchConsultas, fetchEventos]);
    ...
    return (
      <div className="mx-auto">
        <div className="animate-pulse space-y-6">
          ...
          {/* Skeleton - Historial de consultas */}
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="p-3 border-b border-gray-200">
                  ...
                  consulta.slice(-3).map((datos) => (
                    <tr key={datos.id} className="hover:bg-blue-50 transition-colors duration-150">
                      <td className="py-4 px-4 text-center text-sm text-gray-900 whitespace-nowrap">
                        <div className="flex flex-col items-center">
                          <span className="font-medium">
                            {new Date(new Date(datos.fecha_medicion).getTime() + 86400000).toLocaleDateString("es-ES", {
                              day: "numeric",
                              month: "short",
                            })}
                          </span>
                      ...
                      <td className="py-4 px-4 text-center text-sm">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${datos.imc < 18.5 ? 'bg-blue-100 text-blue-800' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setDatosFormulario({ ...datosFormulario, peso: e.target.value ? Number(e.target.value) : 0 })}
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setDatosFormulario({ ...datosFormulario, estatura: e.target.value ? Number(e.target.value) : 0 })}
                  />
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDatosFormulario({ ...datosFormulario, circunferencia_cintura: e.target.value ? Number(e.target.value) : 0 })}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDatosFormulario({ ...datosFormulario, circunferencia_cadera: e.target.value ? Number(e.target.value) : 0 })}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDatosFormulario({ ...datosFormulario, circunferencia_brazo: e.target.value ? Number(e.target.value) : 0 })}
                />
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDatosFormulario({ ...datosFormulario, pliegue_bicipital: e.target.value ? Number(e.target.value) : 0 })}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDatosFormulario({ ...datosFormulario, pliegue_tricipital: e.target.value ? Number(e.target.value) : 0 })}
                />
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setDatosFormulario({
                        ...datosFormulario,
                        glucosa: e.target.value ? Number(e.target.value) : 0,
                      })
                    }
                  />
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setDatosFormulario({
                        ...datosFormulario,
                        colesterol: e.target.value ? Number(e.target.value) : 0,
                      })
                    }
                  />
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      setDatosFormulario({
                        ...datosFormulario,
                        trigliceridos: e.target.value ? Number(e.target.value) : 0,
                      })
                    }
                  />
                </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                    name="fecha_medicion"
                    value={new Date(datosFormulario.fecha_medicion).toISOString().split('T')[0] || ""}
                    onChange={(e) => setDatosFormulario({ ...datosFormulario, fecha_medicion: new Date(e.target.value) })}
                  />
                </div>
              </div>
              ...
              <SelectorCitaModal
                eventos={eventos}
                onSelect={(fecha) =>
                  setDatosFormulario((prev) => ({ ...prev, siguiente_consulta: new Date(fecha) }))
                }
              />
