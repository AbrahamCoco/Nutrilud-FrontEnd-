...
export default function PacientesPage() {
  ...
  const columns = [
    ...
    {
      name: "Nombre",
      selector: (row: Paciente) => `${row.nombrePaciente}`,
      sortable: true,
    },
    {
      name: "Sexo",
    ...
    {
      name: "Correo",
      selector: (row: Paciente) => row.correo,
      sortable: true,
    },
    {
      name: "Teléfono",
    ...
    },
    {
      ...
      cell: (row: Paciente) => (
        <div className="flex justify-center">
          <Link href={`/nutriologo/pacientes/${row.id_paciente}`}>
  ...
  return (
    <div className="mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <NuevoPaciente data={loadPacientes} />
      </div>
